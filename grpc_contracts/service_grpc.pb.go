...
func (c *geoProviderClient) Geocode(ctx context.Context, in *GeocodeRequest, opts ...grpc.CallOption) (*GeocodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/github.com.sephir4ik.geoservice_contracts.GeoProvider/Geocode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *geoProviderClient) SearchAddresses(ctx context.Context, in *SearchAddressesRequest, opts ...grpc.CallOption) (*SearchAddressesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/github.com.sephir4ik.geoservice_contracts.GeoProvider/SearchAddresses", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GeoProvider_Geocode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.sephir4ik.geoservice_contracts.GeoProvider/Geocode",
	}
...
func _GeoProvider_SearchAddresses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.sephir4ik.geoservice_contracts.GeoProvider/SearchAddresses",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var GeoProvider_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.sephir4ik.geoservice_contracts.GeoProvider",
